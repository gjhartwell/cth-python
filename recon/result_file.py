...
class result_file:
    def __init__(self, file_name, is_reconstruction):
        data = Dataset(file_name, 'r')
        
        #print(data.variables.keys())

        self.g2 = data.variables['g2'][:]
        ...
        if is_reconstruction:
           self.param_value = data.variables['param_value'][:][-1]
           self.param_sigma = data.variables['param_sigma'][:][-1]
