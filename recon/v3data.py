...
class V3Data:
    ...
    def raw_currents(self):
        ...
        tvf_current = CTHData(self.shot, '\I_TVF')#CTHData(self.shot, 1, channel_number=True)
        ...
        tf_current = CTHData(self.shot, '\I_TF')#CTHData(self.shot, 3, channel_number=True)

        hf_ovf_current = zero_beginning(np.interp(time, hf_ovf_current.time, hf_ovf_current.data))
        tvf_current = np.interp(time, tvf_current.time, tvf_current.data)
        svf_current = zero_beginning(np.interp(time, svf_current.time, svf_current.data))*0
        ...
        curtor = CTHData(self.shot, '\I_P').data
        vv_current = ((vloop * 355.9) + (33.3 + (PI264 * 0.048446)))
        
        vv1 = CTHData(self.shot, '\V_LOOP_UI')
        vv2 = CTHData(self.shot, '\V_LOOP_UO')
        vv3 = CTHData(self.shot, '\V_LOOP_LI')
        vv4 = CTHData(self.shot, '\V_LOOP_LO')
        
        vv_current = 355.9*(vv1.data + vv2.data +vv3.data + vv4.data) + 33.3 + curtor*0.048446
        #curtor =  (PI264 - (vv_current * 0.022))
        
        # flip phiedge when currents reversed
        #phiedge = ((-2.216E-5*tvf_current) + (3.264E-5*svf_current) + (-2.192E-7*curtor)) + -1.576E-2
        phiedge = abs(((-2.216E-5*tvf_current) + (3.264E-5*svf_current) + (-2.192E-7*curtor)) + -1.576E-2)
        ...
        hcf_current = np.mean([hcf40, hcf41, hcf36, hcf37, hcf38, hcf39, hcf32,
                               hcf33, hcf34, hcf35], axis=0)*120

        currents = [curtor, hf_ovf_current, tvf_current, oh_current, svf_current,
                    rf_ef_current, tf_current, vv_current, hcf_current/120,
    ...
    def raw_magnetics(self):
        ...
        time_ind1 = self.find_closest_index(time, 0)
        time_ind2 = self.find_closest_index(time, 0.62)
        ...
        def rm_mut(raw_array, coil_array, mutual_array):
            ...
            #print(len(raw_array), len(coil_array[0]))
            ...
            new_array = raw_array - array1 + np.mean(array1[self.ind1:self.ind2])
        ...
        #PI096A = correct(PI096A)
        PI096B = CTHData(self.shot, 181, channel_number=True).data
        PI096B = rm_mut(zero_beginning(PI096B/100), 
                                       currents, 
        ...
        PI096C = rm_mut(zero_beginning(PI096C/100), 
                                       currents, 
        ...
        PI096D = rm_mut(zero_beginning(PI096D/100), 
                                       currents, 
        ...
        PI096E = rm_mut(zero_beginning(PI096E/100), 
                                       currents, 
        ...
        PI096F = rm_mut(zero_beginning(PI096F/100), 
                                       currents, 
        ...
        PI096G = rm_mut(zero_beginning(PI096G/100), 
                                       currents, 
        ...
        PI096H = rm_mut(zero_beginning(PI096H/100), 
                                       currents, 
        ...
        PI096I = rm_mut(zero_beginning(PI096I/100), 
                                       currents, 
        ...
        PI096J = rm_mut(zero_beginning(PI096J/100), 
                                       currents, 
        ...
        PI096K = rm_mut(zero_beginning(PI096K/100), 
                                       currents, 
        ...
        PI096L = rm_mut(zero_beginning(PI096L/100), 
                                       currents, 
        ...
        PI096M = rm_mut(zero_beginning(PI096M/100), 
                                       currents, 
        ...
        PI096O = rm_mut(zero_beginning(PI096O/100), 
                                       currents, 
        ...
        PI096P = rm_mut(zero_beginning(PI096P/100), 
                                       currents, 
        ...
        PI32A  = rm_mut(zero_beginning(PI32A/100), 
                                       currents, 
        ...
        PI32B  = rm_mut(zero_beginning(PI32B/100), 
                                       currents, 
        ...
        PI32C  = rm_mut(zero_beginning(PI32C/100), 
                                       currents, 
        ...
        PI32D  = rm_mut(zero_beginning(PI32D/100), 
                                       currents, 
        ...
        PI32E  = rm_mut(zero_beginning(PI32E/100), 
                                       currents, 
        ...
        PI32F  = rm_mut(zero_beginning(PI32F/100), 
                                       currents, 
        ...
        PI32G  = rm_mut(zero_beginning(PI32G/100), 
                                       currents, 
        ...
        PI32H  = rm_mut(zero_beginning(PI32H/100), 
                                       currents, 
        ...
        PI32I  = rm_mut(zero_beginning(PI32I/100), 
                                       currents, 
        ...
        PI32J  = rm_mut(zero_beginning(PI32J/100), 
                                       currents, 
        ...
        PI32K  = rm_mut(zero_beginning(PI32K/100), 
                                       currents, 
        ...
        PI32L  = rm_mut(zero_beginning(PI32L/100), 
                                       currents, 
        ...
        PI32M  = rm_mut(zero_beginning(PI32M/100), 
                                       currents, 
        ...
        PI32N  = rm_mut(zero_beginning(PI32N/100), 
                                       currents, 
        ...
        PI264A = rm_mut(zero_beginning(PI264A/100), 
                                       currents, 
        ...
        PI264B = rm_mut(zero_beginning(PI264B/100), 
                                       currents, 
        ...
        PI264C = rm_mut(zero_beginning(PI264C/100), 
                                       currents, 
        ...
        PI264D = rm_mut(zero_beginning(PI264D/100), 
                                       currents, 
        ...
        PI264E = rm_mut(zero_beginning(PI264E/100), 
                                       currents, 
        ...
        PI264F = rm_mut(zero_beginning(PI264F/100), 
                                        currents, 
        ...
        PI264G = rm_mut(zero_beginning(PI264G/100), 
                                       currents, 
        ...
        PI264H = rm_mut(zero_beginning(PI264H/100), 
                                       currents, 
        ...
        bottom_A = rm_mut(zero_beginning(bottom_A/400), 
                                         currents, 
        ...
        bottom_B = rm_mut(zero_beginning(bottom_B/300), 
                                         currents, 
        ...
        bottom_C = rm_mut(zero_beginning(bottom_C/300), 
                                         currents, 
        ...
        bottom_D = rm_mut(zero_beginning(bottom_D/300), 
                                         currents, 
        ...
        top_A = rm_mut(zero_beginning(top_A/300), 
                                      currents, 
        ...
        top_B = rm_mut(zero_beginning(top_B/300), 
                                      currents, 
        ...
        top_C = rm_mut(zero_beginning(top_C/300), 
                                      currents, 
        ...
        top_D = rm_mut(zero_beginning(top_D/300), 
                                      currents, 
        ...
        cube_AA = rm_mut(zero_beginning(cube_AA/100), 
                                        currents, 
        ...
        cube_AB = rm_mut(zero_beginning(cube_AB/100), 
                                        currents, 
        ...
        cube_BA = rm_mut(zero_beginning(cube_BA/100), 
                                        currents, 
        ...
        cube_BB = rm_mut(zero_beginning(cube_BB/100), 
                                        currents, 
        ...
        cube_CA = rm_mut(zero_beginning(cube_CA/100), 
                                        currents, 
        ...
        cube_CB = rm_mut(zero_beginning(cube_CB/100), 
                                        currents, 
        ...
        cube_DA = rm_mut(zero_beginning(cube_DA/100), 
                                        currents, 
        ...
        cube_DB = rm_mut(zero_beginning(cube_DB/100), 
                                        currents, 
        ...
        cube_EA = rm_mut(zero_beginning(cube_EA/100), 
                                        currents, 
        ...
        cube_EB = rm_mut(zero_beginning(cube_EB/100), 
                                        currents, 
        ...
        cube_FA = rm_mut(zero_beginning(cube_FA/100), 
                                        currents, 
        ...
        cube_FB = rm_mut(zero_beginning(cube_FB/100), 
                                        currents, 
        ...
        np.savetxt('PI.txt',np.array(PI096A))
    ...
    def raw_density(self):
        ...
        try:
            int004 = 0.5 * CTHData(self.shot, 'processed:intfrm_1mm:int_nedl_4').data        
        except:
            int004 = int003
        time = CTHData(self.shot, 'processed:intfrm_1mm:int_nedl_2').time
        #int_diagnostic = [int001, int002, int003, int004]
        int_diagnostic = [int003, int002, int001, int004] # to match 4channel ipch file
    ...
    def raw_sxr(self):
        ...
        SC252_300_18_12 = (SC252_300_18_11+SC252_300_18_13)/2
        #3.0um filter
        #Middle Camera
        ...
        SC252_000_30_9 = (SC252_000_30_8+SC252_000_30_10)/2
        SC252_000_30_12 = (SC252_000_30_11+SC252_000_30_13)/2
        ...
        SC252_060_30_8 = (SC252_060_30_7 + SC252_060_30_9)/2
        
        SC252_060_30_20 = SC252_060_30_19*.9
        ...
        SC252_300_30_16 = (SC252_300_30_15+SC252_300_30_17)/2
